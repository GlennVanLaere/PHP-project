...
<body class="place">
    ...
    <form action="" class="form-group">
        ...
        <p id="result" style="font-weight: bold; text-align: center">Room Z2.04 is located on the 2nd floor in Campus De Ham</p>
        <a id="map" style="text-align: center" target="_blank" href="https://maps.google.com/?q=Thomas More Mechelen - Campus De Ham">View on Google Maps</a>
    </form>
