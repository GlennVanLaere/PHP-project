<div>
    <a href="chat.php?messageid=<?php echo htmlspecialchars($person->getBuddyId()); ?>" class="btn btn-grey btn-block">Open chat<?php if ($person->messageSenders($person->getUserId(), $person->getBuddyId())) { echo " 🔔";}?></a>
    <?php if ($person->hasBuddy($person->getBuddyId())): ?>
    <a href="#" id="btnRemoveBuddy" data-buddy="<?php echo htmlspecialchars($person->getBuddyId()); ?>" class="btn btn-danger btn-block">Remove buddy</a>
    ...
    <a href="#" id="btnIgnoreRequest" data-buddy="<?php echo htmlspecialchars($person->getBuddyId()); ?>" class="btn btn-grey btn-block">Ignore</a>
