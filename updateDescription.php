...
<?php include("includes/nav.inc.php") ?>
    <form action="" method="post">
        ...
        <textarea name="description" id="description" cols="30" rows="10" > <?php echo $showDescription ?> </textarea>
        <button type="submit" name="updateDes" class="btn btn-primary">Update</button>
    </form>
