<div>
    <a href="chat.php?messageid=<?php echo $person->getBuddyId(); ?>" class="btn btn-success btn-block">Open chat<?php if ($person->messageSenders($person->getUserId(), $person->getBuddyId())) { echo " 🔔";}?></a>
    ...
    <a href="#" id="btnIgnoreRequest" data-buddy="<?php echo $person->getBuddyId(); ?>" class="btn btn-danger btn-block">Ignore</a>
    <a href="#" id="btnAcceptRequest" data-buddy="<?php echo $person->getBuddyId(); ?>" class="btn btn-info btn-block">Accept</a>
    <textarea id="textIgnoreRequest" class="form-control" rows="4" placeholder="Reason"></textarea>
    <?php else: ?>
    <a href="#" id="btnSendRequest" data-buddy="<?php echo $person->getBuddyId(); ?>" class="btn btn-danger btn-block">Send Request</a>
