...
--
-- Host: 127.0.0.1:3306
-- Gegenereerd op: 30 mrt 2020 om 20:51
-- Serverversie: 8.0.18
-- PHP-versie: 7.3.12
...
(27, 'greg@student.thomasmore.be', 'Greg', 'Max', '$2y$14$XRAlnE2iB6PC0N9ViUoZDOPPnZFQ1k0KAid9FxbRUl56BttMjk/2y', 'Electronisch', 'Drama', 'Race', 'Nieuws', 'Detectieve', 'Ik wil een buddy die mij helpt'),
(30, 'rnummer@student.thomasmore.be', 'Greg', 'Max', '$2y$16$2TEJAnQP/.zyeMVryMWaiOZ6vbJ6cM/Cv33c15Ya2AqbcxUljCe2e', 'Maak een keuze', 'Maak een keuze', 'Maak een keuze', 'Maak een keuze', 'Maak een keuze', 'Ik wil een buddy die mij helpt');
COMMIT;
