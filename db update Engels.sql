...
--
-- Host: 127.0.0.1:3306
-- Gegenereerd op: 01 apr 2020 om 09:08
-- Serverversie: 8.0.18
-- PHP-versie: 7.3.12
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `music` varchar(300) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT 'Make a choice',
  `movies` varchar(300) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT 'Make a choice',
  `games` varchar(300) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT 'Make a choice',
  `tvShows` varchar(300) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT 'Make a choice',
  `books` varchar(300) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT 'Make a choice',
...
INSERT INTO `users` (`id`, `email`, `firstName`, `lastName`, `password`, `music`, `movies`, `games`, `tvShows`, `books`, `buddy`) VALUES
